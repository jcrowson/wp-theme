...
<a class="col-12 col-md-6 col-lg-4 no-underline" href="tag/popular-tutorials">
  <div class="card category-card hover-pop mb-4" style="background-image: url('<?= get_bloginfo('wpurl') . '/wp-content/uploads/most-read-react-tutorials.jpg' ?>')">
    Most Read Tutorials
  </div>
</a>